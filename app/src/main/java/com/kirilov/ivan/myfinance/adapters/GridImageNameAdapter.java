...
import com.kirilov.ivan.myfinance.AnalyzeActivity;
    ...
    public GridHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapterType == 3){
                    //it's a wallet
                    IncomeActivity.walletId = walletsArrayList.get(pos).getWalletId();
                    ExpenseActivity.walletId = walletsArrayList.get(pos).getWalletId();
                } else {
                    //it's a category
                    AnalyzeActivity.categoryId = categoryArrayList.get(pos).getCatId();
                    IncomeActivity.categoryId = categoryArrayList.get(pos).getCatId();
                    ExpenseActivity.categoryId = categoryArrayList.get(pos).getCatId();
                }
