 ...
 */
public class FirebaseDetailsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firebase_activity_details);
        context = this;
        ...
        fabAddTransaction = (AddFloatingActionButton) findViewById(R.id.details_transaction_action);
...
//
//        incomeAdapter = new TransactionDetailsRowAdapter(context, getLayoutInflater());
//        expenseAdapter = new TransactionDetailsRowAdapter(context, getLayoutInflater());
//
    ...
    public void inflateWithData(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()){
                    for (DataSnapshot child : dataSnapshot.getChildren()){
                        incomeFragment.addIncomeCat(child.getValue(Category.class));

                        Query query = refIncomeCatTransactions.child(child.getKey()).child(Long.toString(beginOfMonthInMs)).orderByKey();
        ...
        refExpenseCatInfo.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()){
                    for (DataSnapshot child : dataSnapshot.getChildren()) {
                        expenseFragment.addIncomeCat(child.getValue(Category.class));

                        Query query = refExpenseCatTransactions.child(child.getKey()).child(Long.toString(beginOfMonthInMs)).orderByKey();
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.hasChildren()){
...
//                Log.d("EXCEPTION:", "IndexOutOfBounts at FirebaseDetailsActivity");
//            }
//
//        }
    }
...
//        Calendar.getInstance();
        ...
        switch (detailsTabLayout.getSelectedTabPosition()){
            case 0:
                ...
                Intent incomeIntent = new Intent(context, FirebaseIncomeActivity.class);
            ...
            case 1:
                ...
                Intent expenseIntent = new Intent(context, FirebaseExpenseActivity.class);
