 ...
 */
public class WalletsHistoryRowAdapter extends RecyclerView.Adapter<WalletsHistoryRowAdapter.RowHolder>{
    ...
    public WalletsHistoryRowAdapter(Context context, RecyclerView recyclerView, ArrayList<String> walletsMonth, ArrayList<Double> walletsBalance) {
    ...
    public RowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, FirebaseMonthActivity.class);
