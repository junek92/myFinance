 ...
 */
public class DetailsExpandListAdapter extends BaseExpandableListAdapter {
    ...
    public DetailsExpandListAdapter(Context context, LayoutInflater layoutInflater){
...
//        return transactions.get(childPosition);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = mLayoutInflater.inflate(R.layout.expand_list_details_parent, parent, false);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = mLayoutInflater.inflate(R.layout.expand_list_details_child, parent, false);
