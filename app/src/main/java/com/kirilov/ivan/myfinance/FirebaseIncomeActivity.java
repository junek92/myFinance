 ...
 */
public class FirebaseIncomeActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firebase_activity_income);
        context = this;
        ...
        toolbar = (Toolbar) findViewById(R.id.firebase_income_toolbar);
        setSupportActionBar(toolbar);

        amountText = (TextInputEditText) findViewById(R.id.firebase_income_amount);
        descriptionText = (TextInputEditText) findViewById(R.id.firebase_income_description);

        if (extraTransaction.getTrAmount() != 0d){
            isNewTransaction = false;

            Button btnSave = (Button) findViewById(R.id.firebase_income_btn_add);
            btnSave.setText(getResources().getString(R.string.income_btn_save));

            Button btnDelete = (Button) findViewById(R.id.firebase_income_btn_delete);
        ...
        currencyText = (TextView) findViewById(R.id.firebase_income_currency);
    ...
    public void setupWalletsRecycleView(){
        walletsRecycleView = (RecyclerView) findViewById(R.id.firebase_income_wallet_recycle);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()){
                    ...
                    Toast.makeText(context, "Error.", Toast.LENGTH_SHORT).show();
                    FirebaseIncomeActivity.this.finish();
                }
            }
    ...
    public void setupCategoriesRecycleView(){
        categoriesRecyclerView = (RecyclerView) findViewById(R.id.firebase_income_category_recycle);
    ...
    private void setupDatePickerDialog(){
        dateText = (TextView) findViewById(R.id.firebase_income_date);
