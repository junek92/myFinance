 ...
 */
public class FirebaseWalletsActivity extends BaseActivity {
    ...
    private WalletsEditRowAdaptor mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firebase_activity_wallets);

        context = this;
        walletsArrayList = new ArrayList<>();

        toolbar = (Toolbar) findViewById(R.id.firebase_wallets_toolbar);
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.firebase_wallets_recycle_view);
        ...
        // specify an adapter
        mAdapter = new WalletsEditRowAdaptor(context, recyclerView, walletsArrayList);
...
//                    progressBar.setVisibility(View.GONE);
    ...
    public void btnAddNewWallet(View view){
        ...
        Intent intent = new Intent(this, FirebaseCreateWalletActivity.class);
