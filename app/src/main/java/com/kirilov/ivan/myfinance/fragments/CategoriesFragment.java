...
import com.kirilov.ivan.myfinance.adapters.CardViewEditCategoryAdapter;
...
public class CategoriesFragment extends Fragment {
    ...
    CardViewEditCategoryAdapter mAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context = getActivity();
        mAdapter = new CardViewEditCategoryAdapter(context, recyclerView);
