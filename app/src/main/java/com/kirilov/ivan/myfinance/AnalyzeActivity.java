...
public class AnalyzeActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.analyze_toolbar);
        setSupportActionBar(toolbar);

        mTextView = (TextView) findViewById(R.id.analyze_date);
...
//                Log.d("ANALYZE: ", " Number: " + inputData[i]);
        ...
        barChart = (BarChart) findViewById(R.id.analyze_bar_chart);
