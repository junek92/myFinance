...
public class ExpenseActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        amountText = (TextInputEditText) findViewById(R.id.expense_amount);
        descriptionText = (TextInputEditText) findViewById(R.id.expense_description);

        if (extraTransaction.getTrAmount() != 0d){
            isNewTransaction = false;

            Button btnSave = (Button) findViewById(R.id.expense_btn_add);
            ...
            Button btnDelete = (Button) findViewById(R.id.expense_btn_delete);
        ...
        currencyText = (TextView) findViewById(R.id.expense_currency);
    ...
    public void setupWalletsRecycleView(){
        walletsRecycleView = (RecyclerView) findViewById(R.id.expense_wallet_recycle_view);
    ...
    public void setupCategoriesRecycleView(){
        ...
        categoriesRecyclerView = (RecyclerView) findViewById(R.id.expense_category_recycle_view);
