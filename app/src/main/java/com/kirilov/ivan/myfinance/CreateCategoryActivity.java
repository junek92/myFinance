...
public class CreateCategoryActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.create_category_toolbar);
        setSupportActionBar(toolbar);

        Intent intent = getIntent();
        if (!intent.hasExtra(Constants.EXTRA_CATEGORY)){
                Log.d(Constants.LOG_APP_ERROR, "\tCreateCategoryActivity -> NO INTENT EXTRA -> CATEGORY");
            finish();
        }
        extraCategory = intent.getExtras().getParcelable(Constants.EXTRA_CATEGORY);

        appBarLayout = (AppBarLayout) findViewById(R.id.create_category_app_bar_layout);

        catNameEditText = (TextInputEditText) findViewById(R.id.create_category_name);
        ...
        btnAdd = (Button) findViewById(R.id.create_category_button);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.create_category_recycle_view);
