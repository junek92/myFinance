...
//        getSupportActionBar().setHomeButtonEnabled(true);
        ...
        descText = (TextView) findViewById(R.id.addCredit_editDesc);
        currencyText = (TextView) findViewById(R.id.addCredit_textCurrency);
    ...
    // add new Credit transaction - check input data and do the query
    public void addCreditTransaction(View view){
        ...
        try {
            transaction.setTrAmount(Double.parseDouble(amountText.getText().toString()));
    ...
    public void inflateCategorySpinner() {
        spinnerCategory = (Spinner) findViewById(R.id.addCredit_spinnerCat);
    ...
    public void inflateAccSpinner(){
        spinnerAcc = (Spinner) findViewById(R.id.addCredit_spinnerAcc);
        financeDbHelper = FinanceDbHelper.getInstance(getApplicationContext());
        SQLiteDatabase sqLiteDatabase = financeDbHelper.getReadableDatabase();
