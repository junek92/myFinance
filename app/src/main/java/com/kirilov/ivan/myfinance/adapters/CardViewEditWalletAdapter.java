 ...
 */
public class CardViewEditWalletAdapter extends RecyclerView.Adapter<CardViewEditWalletAdapter.RowHolder> {
    private Context mContext;
    private RecyclerView mRecyclerView;
    private ArrayList<Wallet> walletsArrayList;
    private TypedArray walletIconsTypedArray;

    public CardViewEditWalletAdapter(Context context, RecyclerView recyclerView, ArrayList<Wallet> walletsArrayList) {
...
//                Toast.makeText(mContext, "EDIT pos: " + position + " ID: " + walletsArrayList.get(position).getWalletId(), Toast.LENGTH_LONG ).show();
        ...
        //// TODO: 13-Jul-16 Implement delete wallet
