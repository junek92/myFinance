 ...
 */
public class FirebaseTransferActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firebase_activity_transfer);
...
//        Utilities.addIncomeToWallet(0L, transToDelete, context);
    ...
    public void setupWalletsRecycleView(){
        walletsFromRecycleView = (RecyclerView) findViewById(R.id.transfer_from_wallet_recycle);
        walletsToRecycleView = (RecyclerView) findViewById(R.id.transfer_to_wallet_recycle);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()){
                    ...
                    Toast.makeText(context, "Error.", Toast.LENGTH_SHORT).show();
                    FirebaseTransferActivity.this.finish();
                }
            }
